...
var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study. In this study you’ll answer questions about 5 stories that you’ll read. It will take approximately <strong>15</strong> minutes. Please only participate once and please do not participate using a mobile device! <br>Note: <strong>The stories might include sensitive content.</strong>",
    legal_info:
    ...
    render: function(CT) {
        ...
        $("#submit_response").on("click", function() {
            ...
            if (slider_changed == true || box_checked == true || $('#slider').val() != 50 || $('input[name="conv"]:checked').val() != undefined){
                ...
                $('#submit_response').css({"display": "none"});
...
var main10 = {
    ...
    render: function(CT) {
        ...
        $(".comment-sect-obligatory").css({"display": "block"});
        ...
        // and additional information are stored in exp.trial_info
        $("#next").on("click", function() {
            console.log($("#story_comments_obl").val());
            ...
            if ((slider_changed == true || box_checked == true || $('#slider').val() != 50 || $('input[name="conv"]:checked').val() != undefined) & $("#story_comments_obl").val().length > 1){
            // if (slider_changed == true || $('#slider').val() != 50){
                ...
                var trial_data = {
                    ...
                    box_checked: $('#checkbox').prop('checked'),
                    convbox_val: conv_var,
                    story_comments: $("#story_comments_obl").val()
                };
                console.log(trial_data);
                // exp.global_data.story_comments = $("#story_comments").val();
                exp.trial_data.push(trial_data);
